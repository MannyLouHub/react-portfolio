        ...
        <div className="col-12 col-md-12 col-lg-9 pt-5">
          ...
          <div className="row">
            <p className="col shortDesc">
              Full-stack web developer with a background in Corporate IT, Healthcare IT, and Computer Software Engineering
              Degree. Comfortable with being a team player, coordinating well with others, and passionate about my
              problem-solving skills. I like to challenge myself to find the best possible outcome for any given scenario. This attitude
              allowed me to achieve a Full Stack Certificate in 6 months to jump-start my dream job as a Software Developer. This
